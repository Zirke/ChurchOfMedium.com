...
class Model_Version_1_01a(tf.keras.Model):
    def __init__(self):
        super(Model_Version_1_01a, self).__init__()
        ...
        # self.maxpol03 = MaxPooling2D(pool_size=(2, 2),  # pool size
        #                              strides=(2, 2),  # stride size
        #                              padding='same',  # padding
        #                              data_format=None)  #
        self.conv5 = Conv2D(256,  # filters
                            ...
                            kernel_constraint=None,  #
                            bias_constraint=None)
        self.maxpol04 = MaxPooling2D(pool_size=(2, 2),  # pool size
                                     strides=(2, 2),  # stride size
                                     padding='same',  # padding
                                     data_format=None)  #
        ...
        self.d3 = Dense(512,  # Amount of neurons
                        activation='relu',  # Activation function
                        use_bias=True,  # bias is enabled
                        bias_initializer='zeros',  # initialisation of bias
                        bias_regularizer=None,  # regularize biases
