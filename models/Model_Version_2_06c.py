...
from tensorflow.keras.layers import Dense, Flatten, Conv2D, MaxPooling2D, ZeroPadding2D,AveragePooling2D, Input, Dropout


class Model_Version_2_06c(tf.keras.Model):
    def __init__(self):
        super(Model_Version_2_06c, self).__init__()
        ...
        self.max_pool_5 = MaxPooling2D(pool_size=(2, 2),  # pool size
                                       strides=(2, 2),  # stride size
                                       padding='valid',  # padding
                                       data_format=None)
        ...
        self.max_pool_6 = MaxPooling2D(pool_size=(2, 2),  # pool size
                                       strides=(2, 2),  # stride size
                                       padding='valid',  # padding
                                       data_format=None)
