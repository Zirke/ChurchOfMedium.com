...
class Model_Version_2_04(tf.keras.Model):
    def __init__(self):
        super(Model_Version_2_04, self).__init__()

        # first convolutional layer
        self.conv1 = Conv2D(2,  # filters
                            (3, 3),  # Kernel size
                            strides=(1, 1),  # Stride
        ...
        self.conv10 = Conv2D(1024,  # filters
                            (3, 3),  # Kernel size
                            strides=(1, 1),  # Stride
                            padding='same',  # Same refers to same padding as previous layer.
                            data_format=None,
        ...
        self.conv11 = Conv2D(2048,  # filters
                            (3, 3),  # Kernel size
                            strides=(1, 1),  # Stride
                            padding='same',  # Same refers to same padding as previous layer.
                            data_format=None,
        ...
        self.conv12 = Conv2D(4096,  # filters
                            (3, 3),  # Kernel size
                            strides=(1, 1),  # Stride
                            padding='same',  # Same refers to same padding as previous layer.
                            data_format=None,
