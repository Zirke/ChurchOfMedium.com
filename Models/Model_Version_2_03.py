...
class Model_Version_2_03(tf.keras.Model):
    def __init__(self):
        super(Model_Version_2_03, self).__init__()
        ...
        self.conv6 = Conv2D(1024,  # filters
                            (3, 3),  # Kernel size
                            strides=(1, 1),  # Stride
                            padding='same',  # Same refers to same padding as previous layer.
                            data_format=None,
        ...
        self.dropout5 = Dropout(rate=0.85,
                                noise_shape=None,
                                seed=None
                                )
