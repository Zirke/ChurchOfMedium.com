...
def main_management(request):
    if request == 'Five':
        return ['sorted_tfrecords/five_diagnosis/five_diagnosis_split_training.tfrecord',
                ...
                'sorted_tfrecords/five_diagnosis/five_diagnosis_split_test.tfrecord'], 'five', 'None'
    elif request == 'Negative':
        return ['sorted_tfrecords/negative_binary/negative_binary_training',
                'sorted_tfrecords/negative_binary/negative_binary_val.tfrecord',
                'sorted_tfrecords/negative_binary/negative_binary_test.tfrecord'], 'binary', 'neg'
    elif request == 'BenignC':
        return ['sorted_tfrecords/benign_cal/benign_cal_split_training',
                'sorted_tfrecords/benign_cal/benign_cal_split_val.tfrecord',
                'sorted_tfrecords/benign_cal/benign_cal_split_test.tfrecord'], 'binary', 'bc'
    elif request == 'BenignM':
        return ['sorted_tfrecords/benign_mass/benign_mass_split_training',
                'sorted_tfrecords/benign_mass/benign_mass_split_val.tfrecord',
                'sorted_tfrecords/benign_mass/benign_mass_split_test.tfrecord'], 'binary', 'bm'
    elif request == 'MalignantC':
        return ['sorted_tfrecords/malignant_cal/malignant_cal_split_training',
                'sorted_tfrecords/malignant_cal/malignant_cal_split_val.tfrecord',
                'sorted_tfrecords/malignant_cal/malignant_cal_split_test.tfrecord'], 'binary', 'mc'
    elif request == 'MalignantM':
        return ['sorted_tfrecords/malignant_mass/malignant_mass_split_training',
                'sorted_tfrecords/malignant_mass/malignant_mass_split_val.tfrecord',
                'sorted_tfrecords/malignant_mass/malignant_mass_split_test.tfrecord'], 'binary', 'mm'
